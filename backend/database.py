...
def save_conversation(
    ...
    """Alias for log_conversation (used by storage/db.py)."""
    log_conversation(
...
def save_audit_log(
    ...
    """Alias for log_audit (used by storage/db.py)."""
    log_audit(
...
def get_stats() -> dict:
    ...
    try:
        ...
        return {
            "total_conversations": 0, "total_submissions": 0,
            "pending": 0, "pending_reviews": 0,
            "confirmed": 0, "rejected": 0,
            "total_audit_logs": 0, "avg_confidence": 0.0,
        }
